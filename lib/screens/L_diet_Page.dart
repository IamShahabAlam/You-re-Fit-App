...
class Loss_Diet_Page extends StatefulWidget {

  @override
  _Loss_Diet_PageState createState() => _Loss_Diet_PageState();
}

class _Loss_Diet_PageState extends State< Loss_Diet_Page> {
